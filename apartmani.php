...
?>
            ...
            <section class="render_apart">
                <div class="container">
                    <hgroup class="pano_hdl">
                        <h2>Pogledajte pozicije apartmana i 
				...
				<div class="container">
					...
					<div class="pogodnosti_text">
						...
						<div class="dwnl_links">
							<a href="http://fruske.srdjansrdjanov.info/Apartmani_info/tech_spec.pdf" target="_black"  class="btn white">PREUZMITE TEHNIČKU <br> SPECIFIKACIJU OBJEKTA</a>
							<a href="http://fruske.srdjansrdjanov.info/Apartmani_info/lamela_a.pdf" target="_black" class="btn white">POGLEDAJTE SKICE APARTMANA <br> GOROCVET - LAMELA A</a>
			...
			<section class="sliderSection" id="mySlide2">
					...
					<div class="img_modal">
					<div class="close" ><span class="_1"></span> <span class="_2"></span>	
					</div>
