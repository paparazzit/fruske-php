				...
				<nav class="nav_bar">
					<div class="drop_wrapper">
						...
						<div class="drop_down">
							...
							<a class="link <?php if($pageTitle==='location'){echo"active_nav";}?>" href="lokacija.php">lokacija</a>
							<a class="link <?php if($pageTitle==='resort'){echo"active_nav";}?>" href="resort.php">resort</a>
							<a class="link <?php if($pageTitle==='apartmani'){echo"active_nav";}?>" href="apartmani.php">apartmani</a>
							<a class="link <?php if($pageTitle==='np'){echo"active_nav";}?>" href="nacionalniPark.php">nacionalni park</a>
							<a class="link <?php if($pageTitle==='invest'){echo"active_nav";}?>" href="investitor.php">investitor</a>
						</div>
						<div class="sideNav">
							<div class="icons">
								<!-- <div class="nav-item">
